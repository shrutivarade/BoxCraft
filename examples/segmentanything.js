...
function run() {
  ...
  console.log("BoxCraft object: ",BoxCraft);

  // Resizable Bounding Box
  // BoxCraft.createResizableBBox(document.getElementById('viewer'), function(topleft, bottomright) {
  ...
  BoxCraft.createDraggableBBox(document.getElementById('viewer'), function(topleft, bottomright) {
    console.log(topleft, bottomright);
    segment_box(topleft, bottomright);
  });
