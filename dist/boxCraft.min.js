class $5018ea9c30d774e7$export$247262aa28c26769 {
    ...
    init() {
        ...
        canvasList.push(this.overlayCanvas);
    }
    // addCanvas(canvasElement) {
    //   this.canvasList.push(canvasElement);
    // }
    hideLastCanvas() {
        if (canvasList.length > 0) {
            let lastCanvas = canvasList.pop();
            // lastCanvas.style.display = 'none'; // Hide the canvas
            lastCanvas.removeLastAppendedChild(); // to completely remove the element
        }
    }
    // Method to remove the last appended child from the parent element
    removeLastAppendedChild() {
        let parentElement = this.element.parentElement;
        if (parentElement && parentElement.lastChild) parentElement.removeChild(parentElement.lastChild);
    }
}
...
class $71844dc9f54dfdc2$export$8a7a1b898028e86c extends (0, $5018ea9c30d774e7$export$247262aa28c26769) {
    constructor(element, callback){
        super(element);
        this.callback = callback;
...
window.BoxCraft = new (0, $5018ea9c30d774e7$export$247262aa28c26769)($4fa36e821943b400$var$canvasElement);
window.console.log("BoxCraft VERSION 0.1-alpha");
function $4fa36e821943b400$var$hideLastCanvas() {
    // Assuming boxCraftInstance is an instance of BoxCraft
    window.BoxCraft.hideLastCanvas();
}
// Setup a button or key event listener
document.getElementById("deletebtn").addEventListener("click", $4fa36e821943b400$var$hideLastCanvas);
...
document.getElementById("createBoundingBox").addEventListener("click", ()=>{
    let draggableBBox = new (0, $71844dc9f54dfdc2$export$8a7a1b898028e86c)($4fa36e821943b400$var$canvasElement, (topleft, bottomright)=>{
        console.log("Bounding Box coordinates:", topleft, bottomright);
    });
// bbox.init();
}); // Add event listener to hide the last canvas on some event, e.g., canvas click
 // window.BoxCraft.overlayCanvas.addEventListener('click', function() {
 //   window.BoxCraft.hideLastCanvas();
 // });
