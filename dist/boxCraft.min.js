...
class $e0e05d850538fde1$export$8a7a1b898028e86c extends (0, $fca228c3af8a0080$export$a829527ff4e4114a) {
    ...
    mouseDown(e1) {
        ...
        this.isDrawing = true;
        this.x1 = e1.clientX * window.devicePixelRatio;
        this.y1 = e1.clientY * window.devicePixelRatio;
    ...
    mouseMove(e1) {
        ...
        console.log("Mouse move at: ", this.startX, this.startY);
        this.ctx.strokeRect(this.startX, this.startY, width, height);
    }
    mouseUp(e1) {
        this.isDrawing = false;
        this.x2 = e1.clientX * window.devicePixelRatio;
        this.y2 = e1.clientY * window.devicePixelRatio;
