...
class $71844dc9f54dfdc2$export$bd64c5827f1eba0c extends (0, $5018ea9c30d774e7$export$247262aa28c26769) {
    constructor(element, callback){
        super(element);
        this.callback = callback;
...
document.getElementById("createBoundingBox").addEventListener("click", ()=>{
    let bbox = new (0, $71844dc9f54dfdc2$export$bd64c5827f1eba0c)($4fa36e821943b400$var$canvasElement, (topleft, bottomright)=>{
